...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: 'cover', description: 'Generate cover letter', usage: '/cover [resume-id] --company "..." --role "..."', isLocal: false , implemented: true },
  ...
  { name: 'export', description: 'Export resume to another format', usage: '/export [resume-id] --format docx|markdown|html', isLocal: false , implemented: true },
